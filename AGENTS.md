...
- Crea la clase de la acción en el paquete `ni.uam.edu.TestVerbal.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="ni.uam.edu.TestVerbal.acciones.MostrarImporte"/>
</controlador>
```

```java
package ni.uam.edu.TestVerbal.acciones;
...
- ✅ Coloca las clases de acción en `ni.uam.edu.TestVerbal.acciones`
...
```java
package ni.uam.edu.TestVerbal.pruebas;
...
- Crea un paquete `cuadrosmando` (ej. `ni.uam.edu.TestVerbal.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
