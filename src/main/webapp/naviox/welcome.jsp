...
En TestVerbal-labels_es.properties:
TestVerbal=Tu aplicación
TestVerbal[description]=Tu aplicación hace esto y lo otro

En TestVerbal-messages_en.properties:
